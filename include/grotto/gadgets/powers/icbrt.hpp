/// @file grotto/gadgets/powers/icbrt.hpp
...
#ifndef LIBDPF_INCLUDE_GROTTO_GADGETS_POWERS_ICBRT_HPP__
#define LIBDPF_INCLUDE_GROTTO_GADGETS_POWERS_ICBRT_HPP__
...
struct icbrt
{
    ...
    T operator()(T x)
    {
        ...
        return std::min(1.0 / std::cbrt(static_cast<double>(x)), std::numeric_limits<T>::max());
    }
};

template <>
struct gadget_hints<icbrt>
{
...
#endif  // LIBDPF_INCLUDE_GROTTO_GADGETS_POWERS_ICBRT_HPP__
