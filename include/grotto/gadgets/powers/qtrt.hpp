/// @file grotto/gadgets/powers/qtrt.hpp
...
#ifndef LIBDPF_INCLUDE_GROTTO_GADGETS_POWERS_QTRT_HPP__
#define LIBDPF_INCLUDE_GROTTO_GADGETS_POWERS_QTRT_HPP__
...
struct qtrt
{
    ...
    T operator()(T x)
    {
        ...
        return std::pow(static_cast<double>(x), 0.25);
    }
};

template <>
struct gadget_hints<qtrt>
{
...
#endif  // LIBDPF_INCLUDE_GROTTO_GADGETS_POWERS_QTRT_HPP__
