/// @file grotto/gadgets/powers/isqrt.hpp
...
#ifndef LIBDPF_INCLUDE_GROTTO_GADGETS_POWERS_ISQRT_HPP__
#define LIBDPF_INCLUDE_GROTTO_GADGETS_POWERS_ISQRT_HPP__
...
struct isqrt
{
    ...
    T operator()(T x)
    {
        ...
        return std::min(1.0 / std::sqrt(static_cast<double>(x)), std::numeric_limits<T>::max());
    }
};

template <>
struct gadget_hints<isqrt>
{
...
#endif  // LIBDPF_INCLUDE_GROTTO_GADGETS_POWERS_ISQRT_HPP__
