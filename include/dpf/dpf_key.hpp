...
HEDLEY_PRAGMA(GCC diagnostic pop)
    ...
    constexpr dpf_key(interior_node root,
      ...
      : mutable_wildcard_mask{wild_mask_},
        ...
        common_part_hash_{utils::get_common_part_hash(correction_words, correction_advice)}
    { }
    dpf_key(const dpf_key &) = delete;
    dpf_key(dpf_key &&) noexcept = default;
  ...
  private:
    ...
    interior_node root_;
    interior_node common_part_hash_;
...
HEDLEY_PRAGMA(GCC diagnostic pop)
    ...
    const interior_node & common_part_hash() const { return common_part_hash_; }
