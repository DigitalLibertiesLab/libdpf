...
struct wildcard_tag_{};

struct wildcard_input_tag_ final : public wildcard_tag_ {};
static constexpr auto wildcard_input_tag = wildcard_input_tag_{};

struct wildcard_output_tag_ final : public wildcard_tag_ {};
static constexpr auto wildcard_output_tag = wildcard_output_tag_{};

struct wildcard_input_output_tag_ final : public wildcard_tag_ {};
static constexpr auto wildcard_input_output_tag = wildcard_input_output_tag_{};

wildcard_input_output_tag_ operator|(wildcard_input_tag_, wildcard_output_tag_)
{
    return wildcard_input_output_tag;
}

wildcard_input_output_tag_ operator|(wildcard_output_tag_, wildcard_input_tag_)
{
    return wildcard_input_output_tag;
}
