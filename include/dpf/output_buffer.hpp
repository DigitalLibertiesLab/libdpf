...
auto make_output_buffer_for_interval(InputT from, InputT to)
{
    ...
    // +1 as due to wrapping, it is possible for the first node to be repeated as the last
    std::size_t nodes_in_interval = utils::get_leafnodes_in_output_interval<dpf_type>(from, to)+1;
