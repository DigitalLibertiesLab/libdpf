#ifndef LIBDPF_INCLUDE_DPF_ROTATION_ITERABLE_HPP__
#define LIBDPF_INCLUDE_DPF_ROTATION_ITERABLE_HPP__
...
struct rotation_iterable
{
    ...
    {
        return iterator(begin_, begin_, wrap_to_, wrap_after_, end_after_, end_);
    }
    ...
    {
        return const_iterator(begin_, begin_, wrap_to_, wrap_after_, end_after_, end_);
    }
    ...
    {
        return iterator(end_, begin_, wrap_to_, wrap_after_, end_after_, end_);
    }
    ...
    {
        return const_iterator(end_, begin_, wrap_to_, wrap_after_, end_after_, end_);
    }
...
struct rotation_iterator_base
{
  public:
    ...
    rotation_iterator_base(wrapped_iterator iterator, wrapped_iterator begin,
        wrapped_iterator wrap_to, wrapped_iterator wrap_after,
        wrapped_iterator end_after, wrapped_iterator end)
      : it{iterator}, begin_{begin}, wrap_to_{wrap_to}, wrap_after_{wrap_after},
        end_after_{end_after}, end_{end} { }
    ...
    constexpr bool operator==(const rotation_iterator_base & rhs) const noexcept
    {
        return begin_ == rhs.begin_
                && wrap_to_ == rhs.wrap_to_
                && wrap_after_ == rhs.wrap_after_
                && end_after_ == rhs.end_after_
                && end_ == rhs.end_
                && it == rhs.it;
    }
  ...
  : public rotation_iterator_base<WrappedIterator>
{
  ...
  public:
    ...
    rotation_iterator(wrapped_iterator iterator, wrapped_iterator begin,
        wrapped_iterator wrap_to, wrapped_iterator wrap_after,
        wrapped_iterator end_after, wrapped_iterator end)
      : base{iterator, begin, wrap_to, wrap_after, end_after, end} {}
  ...
  : public rotation_iterator_base<WrappedIterator>
{
  ...
  public:
    ...
    rotation_const_iterator(wrapped_iterator iterator, wrapped_iterator begin,
        wrapped_iterator wrap_to, wrapped_iterator wrap_after,
        wrapped_iterator end_after, wrapped_iterator end)
      : base{iterator, begin, wrap_to, wrap_after, end_after, end} {}
...
#endif  // LIBDPF_INCLUDE_DPF_ROTATION_ITERABLE_HPP__