...
> allParams
{
    ...
    },
    {
        ...
        std::make_tuple(dpf::keyword<4, dpf::alphabets::hex>("7fff"), uint64_t(0x0000000000000001)),
        std::make_tuple(dpf::keyword<4, dpf::alphabets::hex>("7fff"), uint64_t(0x5555555555555555)),
        std::make_tuple(dpf::keyword<4, dpf::alphabets::hex>("7fff"), uint64_t(0xAAAAAAAAAAAAAAAA)),
        std::make_tuple(dpf::keyword<4, dpf::alphabets::hex>("7fff"), uint64_t(0xFFFFFFFFFFFFFFFF)),
        std::make_tuple(dpf::keyword<4, dpf::alphabets::hex>("8000"), uint64_t(0x0000000000000001)),
        std::make_tuple(dpf::keyword<4, dpf::alphabets::hex>("8000"), uint64_t(0x5555555555555555)),
        std::make_tuple(dpf::keyword<4, dpf::alphabets::hex>("8000"), uint64_t(0xAAAAAAAAAAAAAAAA)),
        std::make_tuple(dpf::keyword<4, dpf::alphabets::hex>("8000"), uint64_t(0xFFFFFFFFFFFFFFFF)),
